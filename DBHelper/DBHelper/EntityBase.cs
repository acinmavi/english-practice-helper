...
namespace DBHelper
{
	...
	public static class EntityBase
	{
		...
		static EntityBase()
		{
            ...
            string sdfPath = @"H:/NewDropbox/Dropbox/DungNT (1)/Document/Project/EnglishPracticeHelper/DBHelper/db/EnghlistHelperDB.sdf";
            string password = "123456a@";
            ConnectionString = string.Format("Data Source = {0}; Password = {1}", sdfPath, password);

            ConnectionString = ConfigurationManager.ConnectionStrings["DBManagement"].ConnectionString;
